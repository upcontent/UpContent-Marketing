...
<div class="ck_form ck_vertical_subscription_form">
  ...
  <div class="ck_form_fields">
    <div id="ck_success_msg" style="display:none;">
      <p>Woohoo! Check your email to receive your free workbook.</p>
    </div>

    <!--  Form starts here  -->
    <form id="ck_subscribe_form" class="ck_subscribe_form" action="https://app.convertkit.com/landing_pages/257933/subscribe" data-remote="true">
      ...
      <input type="hidden" name="id" value="257933" id="landing_page_id">
      ...
      <span class="ck_guarantee">
        By signing up, you&#x27;ll also gain access to new blog posts and other helpful resources. You can unsubscribe at any time.
...
<style type="text/css">/* Layout */
  ...
  border-top-color: #7755cd;
	border-bottom: solid 10px #3d3d3d;
  border-bottom-color: #47337b;
...
.ck_form.ck_minimal .ck_subscribe_button {background: #7755CD;}
h3.ck_form_title {color: #7755CD !important;}

.ck_form .ck_powered_by {display: none !important;}

.ck_form.ck_horizontal {
border-bottom-color: #7755cd;
box-shadow: none;
